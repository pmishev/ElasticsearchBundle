        ...
        $node
            ...
            ->prototype('array')
                ->children()
                    ...
                    ->end()
                    ->scalarNode('log_path')
                        ->defaultValue($this->kernelLogsDir.'/elasticsearch.log')
                        ->info('Set the log file path.')
                    ->end()
                    ->scalarNode('log_level')
                        ->defaultValue('warning')
                        ->info('Sets the PSR logging level.')
                        ...
                        ->end()
                    ->end()
                    ->scalarNode('trace_path')
                        ->defaultValue($this->kernelLogsDir.'/elasticsearch.log')
                        ->info('Set the trace file path.')
                    ->end()
                    ->scalarNode('trace_level')
                        ->defaultValue('warning')
                        ->info('Sets the PSR tracing level.')
                        ->defaultValue(LogLevel::WARNING)
                        ->validate()
                        ->ifNotInArray((new \ReflectionClass('Psr\Log\LogLevel'))->getConstants())
                            ->thenInvalid('Invalid PSR trace level.')
                        ->end()
                    ->end()
